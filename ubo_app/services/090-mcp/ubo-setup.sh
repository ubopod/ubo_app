...
# transitive dependencies (fastmcp in particular) resolve to betas.
...
pip install ${WHEELS_DIRECTORY:+--find-links="$WHEELS_DIRECTORY"} --prefer-binary "$MCP_GATEWAY_SOURCE" "$BINDINGS_SOURCE"
